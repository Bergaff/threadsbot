...
export default {
  ...
  <rect x="100" y="475" width="310" height="48" fill="#22252a" stroke="#3d424b" stroke-width="1"/>
  <text x="125" y="506" fill="#ffffff" font-family="system-ui, Arial, sans-serif" font-size="20" font-weight="600">Быстрый поиск по @username</text>
</svg>`;
